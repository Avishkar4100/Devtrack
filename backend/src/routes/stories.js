...
router.post('/generate/:projectId', authorize('manager', 'scrum_master'), generateStories);
router.post('/suggest/:projectId', authorize('manager', 'scrum_master'), suggestStories);
router.post('/save/:projectId', authorize('manager', 'scrum_master'), saveGeneratedStories);
